    ...
    return(
        ...
        <div>
            ...
            <div className="p-3 bg-secondary">
                    <p className="font-size-lg m-0 text-white font-bolder text-center font-size-md">El nuevo estándar del corretaje no se parece a lo que conoces. Ven a descubrirlo</p>
            </div>
        </div>
        </>
    )
