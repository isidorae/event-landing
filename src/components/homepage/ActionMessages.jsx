        ...
        <>
            <div>
                <div className="bg-dark p-3">
                    <p className="m-0 text-white font-bold text-center font-size-md">El corretaje inmobiliario está viviendo una <span className="red-font">trasformación</span> profunda.</p>
                </div>
                <Container>
                    <Row className="font-size-lg m-5 d-flex flex-wrap">
                ...
                <div className="p-5">
                    <section className="text-center text-blue">
                        <h3 className="font-size-xxl font-bolder text-uppercase">¿Y tú? ¿Estás cambiando también?</h3>
                    </section>
                </div>
            </div>
        </>
